...
- **Test:** `crates/mesh50/src/crypto/pskc.rs` → `generates_thread_pskc_test_vector`.
...
- **Regenerate:**
  ...
  ```
- **Test:** `crates/mesh50-dtls/src/tests/keys.rs` → `tls12_prf_matches_openssl_tls1_prf_vector`.
...
- **Regenerate:**
  ...
  ```
- **Test:** `crates/mesh50-dtls/src/tests/keys.rs` → `finished_verify_data_matches_openssl_tls1_prf_vector`.
...
- **Test:** `crates/mesh50-dtls/src/ecjpake/tests.rs` →
...
- **Regenerate:**
  ...
  ```
- **Test:** `crates/mesh50-dtls/src/tests/keys.rs` →
...
- **Regenerate:**
  ...
  ```
- **Test:** `crates/mesh50/src/crypto/pskc.rs` → `compute_joiner_id_matches_openthread`.
...
- **Regenerate:**
  ...
  ```
- **Tests:** `crates/mesh50/src/crypto/pskc.rs` →

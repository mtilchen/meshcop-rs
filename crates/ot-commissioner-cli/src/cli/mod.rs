...
//! `ot-commissioner` CLI using the [`meshcop::commissioner`] API from MeshCoP
//! for Rust. It is driven by the
...
pub async fn run(config_path: Option<&Path>) -> meshcop::Result<()> {
